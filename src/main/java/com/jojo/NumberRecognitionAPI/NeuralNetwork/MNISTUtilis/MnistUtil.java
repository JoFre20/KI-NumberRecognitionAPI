package com.jojo.NumberRecognitionAPI.NeuralNetwork.MNISTUtilis;
...
public class MnistUtil {
	...
	public MnistUtil() throws IOException {
		mnistMatrixs = new MnistDataReader().readData("mnistdata/t10k-images.idx3-ubyte", "mnistdata/t10k-labels.idx1-ubyte");
	}
